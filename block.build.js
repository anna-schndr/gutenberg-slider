...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__gallery_image__ = __webpack_require__(146);
				...
				wp.element.createElement(
					...
					images.map(function (img, index) {
						return wp.element.createElement(
							...
							wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__gallery_image__["a" /* default */], {
								url: img.url,
								alt: img.alt,
								id: img.id,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__block__ = __webpack_require__(129);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
