...
var arrayFilter = __webpack_require__(25),
    baseFilter = __webpack_require__(44),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_filter__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_every__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__block__ = __webpack_require__(129);
...
var settings = {
	...
	transforms: {
		from: [{
			...
			transform: function transform(attributes) {
				var validImages = __WEBPACK_IMPORTED_MODULE_0_lodash_filter___default()(attributes, function (_ref) {
					var id = _ref.id,
					    url = _ref.url;
					return id && url;
				});
			...
			isMatch: function isMatch(files) {
				return files.length !== 1 && __WEBPACK_IMPORTED_MODULE_1_lodash_every___default()(files, function (file) {
	...
	deprecated: [{
		attributes: _extends({}, blockAttributes, {
			images: _extends({}, blockAttributes.images, {
		...
		save: function save(_ref8) {
			...
			return wp.element.createElement(
				...
				images.map(function (image) {
					...
					return wp.element.createElement(
						'figure',
						{ key: image.id || image.url, className: 'blocks-gallery-image' },
						href ? wp.element.createElement(
							'a',
							{ href: href },
							img
...
var arrayEvery = __webpack_require__(126),
    baseEvery = __webpack_require__(127),
    baseIteratee = __webpack_require__(32),
    isArray = __webpack_require__(0),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_filter__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_filter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_filter__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_pick__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gallery_image__ = __webpack_require__(146);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var GalleryBlock = function (_Component) {
	_inherits(GalleryBlock, _Component);

	function GalleryBlock() {
		_classCallCheck(this, GalleryBlock);

		var _this = _possibleConstructorReturn(this, (GalleryBlock.__proto__ || Object.getPrototypeOf(GalleryBlock)).apply(this, arguments));
	...
	_createClass(GalleryBlock, [{
		...
		value: function onRemoveImage(index) {
			...
			return function () {
				var images = __WEBPACK_IMPORTED_MODULE_0_lodash_filter___default()(_this3.props.attributes.images, function (img, i) {
					return index !== i;
				});
		...
		value: function onSelectImages(images) {
			this.props.setAttributes({
				images: images.map(function (image) {
					return __WEBPACK_IMPORTED_MODULE_1_lodash_pick___default()(image, ['alt', 'caption', 'id', 'url']);
				})
			});
		}
	}, {
				...
				wp.element.createElement(
					...
					images.map(function (img, index) {
						return wp.element.createElement(
							...
							wp.element.createElement(__WEBPACK_IMPORTED_MODULE_2__gallery_image__["a" /* default */], {
								url: img.url,
								alt: img.alt,
								id: img.id,
...
/* harmony default export */ __webpack_exports__["a"] = (GalleryBlock);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_classnames__ = __webpack_require__(147);
...
var GalleryImage = function (_Component) {
	_inherits(GalleryImage, _Component);

	function GalleryImage() {
		_classCallCheck(this, GalleryImage);

		var _this = _possibleConstructorReturn(this, (GalleryImage.__proto__ || Object.getPrototypeOf(GalleryImage)).apply(this, arguments));
